...
export default defineComponent({
    mounted() {
        this.loadSubscribers(0, this.perPage, 'subscriber_username', 'asc');
    },
    ...
    setup() {
        ...
        return {
            isLoading, perPage, subscribers,
            usernameSearch, rows, columns,
        };
    },

    methods: {
        loadSubscribers(offset, limit, sort, order) {
            this.isLoading = true;

            let url = route('subscribers.list', {
            ...
            axios.get(url)
                .then((response) => {
                    ...
                    this.subscribers = response.data.total;
