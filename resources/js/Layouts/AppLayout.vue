            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <jet-responsive-nav-link :href="route('bots')" :active="route().current('bots')">
                            Bots
                        </jet-responsive-nav-link>

                        <jet-responsive-nav-link :href="route('followers')" :active="route().current('users')">
                            Followers
                        </jet-responsive-nav-link>

                        <jet-responsive-nav-link :href="route('subscribers')" :active="route().current('subscribers')">
                            Subscriber
                        </jet-responsive-nav-link>
                    </div>
